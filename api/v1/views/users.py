#!/usr/bin/python3
'''
Creates a new view for User object and handles RESTful API actions
'''
...
def get_all_users():
    ...
    '''
    # Gets User objects from the storage and converts them to dictionaries
...
def get_user(user_id):
    ...
    '''
    # Gets the User object with the given ID from the storage
...
def delete_user(user_id):
    ...
    if user:
        ...
        # Returns 404 error if the User object is not found
        abort(404)
...
def create_user():
    ...
    user.save()
    # Returns the newly created User object in JSON format with 201 status code
...
def update_user(user_id):
    ...
    if user:
        ...
        # Saves the updated User object to the storage
        user.save()
